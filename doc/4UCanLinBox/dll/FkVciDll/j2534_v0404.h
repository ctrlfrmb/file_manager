...
#define UART_INIT    					0x06/*Defined By TL*/
...
/*UserDefine-YTL*/
#define START_EXPROG				0x0F //启动外部刷写
#define SET_EX_MONITOR              0x10 //开启或关闭外部刷写时报文检测
#define FS_CHECK                    0x11 //对传输的文件进行校验和假锁
#define FS_CLEAR                    0x12 //清空指定的文件地址，为新的传输做准备
#define FS_WRITE                    0x15 //对文件进行写
#define RAW_INIT                    0x13
#define CAN_ESB                     0x14
#define TSW_CFG                     0x16
#define LOAD_SEQUEUE                0x17
#define LOAD_DATA                   0x18
#define START_EXPROGSEQUEUE         0x19  
...
/*CAN&FD ConfPatter*/
#define DATA_RATE_BRS               0x26
#define NSEG1                       0x27
#define NSEG2                       0x28
#define DSEG1                       0x29
#define DSEG2                       0x2A
#define FILTER_STARTID              0x2B
#define FILTER_STOPID               0x2C
